...
query = """
    CREATE TABLE IF NOT EXISTS sys_invoices_types (
...
with open('Tipos_de_Comprobantes.txt', 'r', encoding='utf-8') as archivo:
    ...
    for linea in lineas:
        ...
        if len(datos) == 4:
            ...
            query = f"INSERT INTO invoices_types (code, description) VALUES  (?,?)"
            ...
            query = f"INSERT INTO sys_invoices_types(code, description) VALUES  (?,?)"
            values = (dato1, dato2)
