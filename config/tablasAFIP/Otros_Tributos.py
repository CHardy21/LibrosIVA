...
query = """
    CREATE TABLE IF NOT EXISTS sys_others_taxes (
...
with open('Otros_Tributos.txt', 'r', encoding='utf-8') as archivo:
    ...
    for linea in lineas:
        ...
        if len(datos) == 4:
            ...
            query = f"INSERT INTO sys_others_taxes (code, description, observations) VALUES  (?,?,?)"
