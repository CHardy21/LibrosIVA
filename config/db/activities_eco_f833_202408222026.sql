INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('011121','Cultivo de maíz','Cultivo de maíz'),
	 ('011129','Cultivo de cereales de uso forrajero n.c.p.','Cultivo de cereales de uso forrajero n.c.p.'),
	 ('011130','Cultivo de pastos de uso forrajero','Cultivo de pastos de uso forrajero '),
	 ('011211','Cultivo de soja','Cultivo de soja'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('011341','Cultivo de legumbres frescas','Cultivo de legumbres frescas (Incluye arveja, chaucha, haba, lupino, etc.)'),
	 ('011342','Cultivo de legumbres secas','Cultivo de legumbres secas (Incluye garbanzo, lenteja, poroto, etc.)'),
	 ('011400','Cultivo de tabaco','Cultivo de tabaco'),
	 ('011501','Cultivo de algodón','Cultivo de algodón'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('012200','Cultivo de frutas cítricas','Cultivo de frutas cítricas (Incluye bergamota, lima, limón, mandarina, naranja, pomelo, kinoto, etc.)'),
	 ('012311','Cultivo de manzana y pera','Cultivo de manzana y pera'),
	 ('012319','Cultivo de frutas de pepita n.c.p.','Cultivo de frutas de pepita n.c.p. (Incluye membrillo, níspero, etc.)'),
	 ('012320','Cultivo de frutas de carozo','Cultivo de frutas de carozo (Incluye cereza, ciruela, damasco, durazno, pelón, etc.)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('012701','Cultivo de yerba mate','Cultivo de yerba mate'),
	 ('012709','Cultivo de té y otras plantas cuyas hojas se utilizan para preparar infusiones','Cultivo de té y otras plantas cuyas hojas se utilizan para preparar infusiones'),
	 ('012800','Cultivo de especias y de plantas aromáticas y medicinales','Cultivo de especias y de plantas aromáticas y medicinales'),
	 ('012900','Cultivos perennes n.c.p.','Cultivos perennes n.c.p.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('014114','Invernada  de ganado bovino excepto el engorde en corrales (Feed-Lot)','Invernada  de ganado bovino excepto el engorde en corrales (Feed-Lot)'),
	 ('014115','Engorde en corrales (Feed-Lot)','Engorde en corrales (Feed-Lot)'),
	 ('014121','Cría de ganado bovino realizada en cabañas','Cría de ganado bovino realizada en cabañas (Incluye: ganado bubalino y la producción de semen)'),
	 ('014211','Cría de ganado equino, excepto la realizada en haras','Cría de ganado equino, excepto la realizada en haras (Incluye equinos de trabajo, asnos, mulas, burdéganos)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('014520','Cría de ganado porcino realizado en cabañas','Cría de ganado porcino realizado en cabañas'),
	 ('014610','Producción de leche bovina','Producción de leche bovina (Incluye la cría para la producción de leche de vaca y la producción de leche bubalina)'),
	 ('014620','Producción de leche de oveja y de cabra','Producción de leche de oveja y de cabra'),
	 ('014710','Producción de lana y pelo de oveja y cabra (cruda)','Producción de lana y pelo de oveja y cabra (cruda)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('014990','Cría de animales y obtención de productos de origen animal, n.c.p.','Cría de animales y obtención de productos de origen animal, n.c.p. (Incluye ciervo, gato, gusano de seda, lombriz, pájaro, perro, rana, animales para experimentación, caracoles vivos, frescos, congelados y secos -excepto marinos-, cera de insectos excepto la de abeja, etc.)'),
	 ('016111','Servicios de labranza, siembra, transplante  y  cuidados culturales','Servicios de labranza, siembra, transplante  y  cuidados culturales'),
	 ('016112','Servicios de pulverización, desinfección y fumigación terrestre','Servicios de pulverización, desinfección y fumigación terrestre'),
	 ('016113','Servicios de pulverización, desinfección y fumigación aérea','Servicios de pulverización, desinfección y fumigación aérea '),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('016210','Inseminación artificial y servicios n.c.p. para mejorar la reproducción de los animales y el rendimiento de sus productos','Inseminación artificial y servicios n.c.p. para mejorar la reproducción de los animales y el rendimiento de sus productos '),
	 ('016220','Servicios de contratistas de mano de obra pecuaria','Servicios de contratistas de mano de obra pecuaria (Incluye arreo, castración de aves, pasturaje,  etc.)'),
	 ('016230','Servicios de esquila de animales','Servicios de esquila de animales'),
	 ('016291','Servicios para el control de plagas, baños parasiticidas, etc.','Servicios para el control de plagas, baños parasiticidas, etc.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('021030','Explotación de viveros forestales','Explotación de viveros forestales (Incluye propagación de especies forestales)'),
	 ('022010','Extracción de productos forestales de bosques cultivados','Extracción de productos forestales de bosques cultivados (Incluye tala de árboles, desbaste de troncos y producción de madera en bruto, leña, postes)'),
	 ('022020','Extracción de productos forestales de bosques nativos','Extracción de productos forestales de bosques nativos (Incluye tala de árboles, desbaste de troncos y producción de madera en bruto, leña, postes, la extracción de rodrigones, varas, varillas y la recolección de  gomas naturales, líquenes, musgos, resinas y de rosa mosqueta,etc)'),
	 ('024010','Servicios forestales para la extracción de madera','Servicios forestales para la extracción de madera (Incluye tala de árboles, acarreo y transporte en el interior del bosque, servicios realizados por terceros, etc.)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('032000','Explotación de criaderos de peces, granjas piscícolas y otros frutos acuáticos  (acuicultura)','Explotación de criaderos de peces, granjas piscícolas y otros frutos acuáticos  (acuicultura)'),
	 ('051000','Extracción y aglomeración de carbón','Extracción y aglomeración de carbón (Incluye la producción de hulla no aglomerada, antracita, carbón bituminoso no aglomerado, ovoides y combustibles sólidos análogos a base de hulla, etc.)'),
	 ('052000','Extracción y aglomeración de lignito','Extracción y aglomeración de lignito (Incluye la producción de lignito aglomerado y no aglomerado)'),
	 ('061000','Extracción de petróleo crudo','Extracción de petróleo crudo (Incluye arenas alquitraníferas, esquistos bituminosos o lutitas, aceites de petróleo y de minerales bituminosos, petróleo, etc.)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('081200','Extracción de piedra caliza y yeso','Extracción de piedra caliza y yeso (Incluye caliza, castina, conchilla, riolita, yeso natural, anhidrita, etc.)'),
	 ('081300','Extracción de arenas, canto rodado y triturados pétreos','Extracción de arenas, canto rodado y triturados pétreos (Incluye arena para construcción, arena silícea, otras arenas naturales, canto rodado, dolomita triturada, salto triturado, piedra partida  y  otros triturados pétreos, etc.)'),
	 ('081400','Extracción de arcilla y caolín','Extracción de arcilla y caolín (Incluye andalucita, arcillas, bentonita, caolín, pirofilita, silimanita, mullita, tierra de chamota o de dinas, etc.)'),
	 ('089110','Extracción de minerales para la fabricación de abonos excepto turba','Extracción de minerales para la fabricación de abonos excepto turba (Incluye guano, silvita, silvinita y otras sales de potasio naturales, etc.)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('101011','Matanza de ganado bovino','Matanza de ganado bovino (Incluye búfalos) '),
	 ('101012','Procesamiento de carne de ganado bovino','Procesamiento de carne de ganado bovino'),
	 ('101013','Saladero y peladero de cueros de ganado bovino','Saladero y peladero de cueros de ganado bovino'),
	 ('101020','Producción y procesamiento de carne de aves','Producción y procesamiento de carne de aves'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('102003','Fabricación de aceites, grasas, harinas y productos a base de pescados','Fabricación de aceites, grasas, harinas y productos a base de pescados '),
	 ('103011','Preparación de conservas de frutas, hortalizas y legumbres','Preparación de conservas de frutas, hortalizas y legumbres'),
	 ('103012','Elaboración y envasado de dulces, mermeladas y jaleas','Elaboración y envasado de dulces, mermeladas y jaleas'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('104020','Elaboración de margarinas y grasas vegetales comestibles similares','Elaboración de margarinas y grasas vegetales comestibles similares'),
	 ('105010','Elaboración de leches y productos lácteos deshidratados','Elaboración de leches y productos lácteos deshidratados (Incluye la obtención de quesos, helados, manteca, postres lácteos, yogur y otros productos lácteos fermentados o coagulados cuando son obtenidos en forma integrada con la producción de leche)'),
	 ('105020','Elaboración de quesos','Elaboración de quesos (Incluye la producción de suero)'),
	 ('105030','Elaboración industrial de helados','Elaboración industrial de helados'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('107110','Elaboración de galletitas y bizcochos','Elaboración de galletitas y bizcochos'),
	 ('107121','Elaboración industrial de productos de panadería, excepto galletitas y bizcochos','Elaboración industrial de productos de panadería, excepto galletitas y bizcochos (Incluye la elaboración de productos de panadería frescos, congelados y secos)'),
	 ('107129','Elaboración de productos de panadería n.c.p.','Elaboración de productos de panadería n.c.p. (Incluye la elaboración de pan, facturas, churros, pre-pizzas, masas de hojaldre, masas fritas, tortas, tartas, etc), (No incluye la fabricación de sándwich 561040)'),
	 ('107200','Elaboración de azúcar','Elaboración de azúcar'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('107912','Elaboración y molienda de hierbas aromáticas y  especias','Elaboración y molienda de hierbas aromáticas y  especias'),
	 ('107920','Preparación de hojas de té','Preparación de hojas de té'),
	 ('107930','Elaboración de yerba mate','Elaboración de yerba mate'),
	 ('107991','Elaboración de extractos, jarabes y concentrados','Elaboración de extractos, jarabes y concentrados'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('110212','Elaboración de vinos','Elaboración de vinos (Incluye el fraccionamiento)'),
	 ('110290','Elaboración de sidra y otras bebidas alcohólicas fermentadas','Elaboración de sidra y otras bebidas alcohólicas fermentadas '),
	 ('110300','Elaboración de cerveza, bebidas malteadas y malta','Elaboración de cerveza, bebidas malteadas y malta'),
	 ('110411','Embotellado de aguas naturales y minerales','Embotellado de aguas naturales y minerales'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('120099','Elaboración de productos de tabaco n.c.p.','Elaboración de productos de tabaco n.c.p.'),
	 ('131110','Preparación de fibras textiles vegetales, desmotado de algodón','Preparación de fibras textiles vegetales, desmotado de algodón (Incluye la preparación de fibras de yute, ramio, cáñamo y lino)'),
	 ('131120','Preparación de fibras animales de uso textil','Preparación de fibras animales de uso textil'),
	 ('131131','Fabricación de hilados textiles de lana, pelos y sus mezclas','Fabricación de hilados textiles de lana, pelos y sus mezclas'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('139100','Fabricación de tejidos de punto','Fabricación de tejidos de punto'),
	 ('139201','Fabricación de frazadas, mantas, ponchos, colchas, cobertores, etc.','Fabricación de frazadas, mantas, ponchos, colchas, cobertores, etc.'),
	 ('139202','Fabricación de ropa de cama y mantelería','Fabricación de ropa de cama y mantelería'),
	 ('139203','Fabricación de artículos de lona y sucedáneos de lona','Fabricación de artículos de lona y sucedáneos de lona'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('141120','Confección de ropa de trabajo, uniformes y guardapolvos','Confección de ropa de trabajo, uniformes y guardapolvos '),
	 ('141130','Confección de prendas de vestir para bebés y niños','Confección de prendas de vestir para bebés y niños'),
	 ('141140','Confección de prendas deportivas','Confección de prendas deportivas'),
	 ('141191','Fabricación de accesorios de vestir excepto de cuero','Fabricación de accesorios de vestir excepto de cuero'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('149000','Servicios industriales para la industria confeccionista','Servicios industriales para la industria confeccionista (Incluye procesos de planchado y acondicionamiento de prendas: teñido, gastado a la piedra (stone wash), impermeabilizado, lavaderos y secaderos industriales, etc.) '),
	 ('151100','Curtido y terminación de cueros','Curtido y terminación de cueros'),
	 ('151200','Fabricación de maletas, bolsos de mano y similares, artículos de talabartería y artículos de cuero n.c.p.','Fabricación de maletas, bolsos de mano y similares, artículos de talabartería y artículos de cuero n.c.p.'),
	 ('152011','Fabricación de calzado de cuero, excepto calzado deportivo y ortopédico','Fabricación de calzado de cuero, excepto calzado deportivo y ortopédico '),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('162201','Fabricación de aberturas y estructuras de madera para la construcción','Fabricación de aberturas y estructuras de madera para la construcción'),
	 ('162202','Fabricación de viviendas prefabricadas de madera','Fabricación de viviendas prefabricadas de madera'),
	 ('162300','Fabricación de recipientes de madera','Fabricación de recipientes de madera'),
	 ('162901','Fabricación de ataúdes','Fabricación de ataúdes'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('170202','Fabricación de cartón ondulado y envases de cartón','Fabricación de cartón ondulado y envases de cartón'),
	 ('170910','Fabricación de artículos de papel y cartón de uso doméstico e higiénico sanitario','Fabricación de artículos de papel y cartón de uso doméstico e higiénico sanitario'),
	 ('170990','Fabricación de artículos de papel y cartón n.c.p.','Fabricación de artículos de papel y cartón n.c.p. (No incluye el papel de lija:  239900)'),
	 ('181101','Impresión de diarios y revistas','Impresión de diarios y revistas'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('201120','Fabricación de curtientes naturales y sintéticos','Fabricación de curtientes naturales y sintéticos'),
	 ('201130','Fabricación de materias colorantes básicas, excepto pigmentos preparados','Fabricación de materias colorantes básicas, excepto pigmentos preparados'),
	 ('201140','Fabricación de combustible nuclear, sustancias y materiales radiactivos','Fabricación de combustible nuclear, sustancias y materiales radiactivos'),
	 ('201180','Fabricación de materias químicas inorgánicas básicas n.c.p.','Fabricación de materias químicas inorgánicas básicas n.c.p.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('202101','Fabricación de insecticidas, plaguicidas y  productos químicos de uso agropecuario','Fabricación de insecticidas, plaguicidas y  productos químicos de uso agropecuario '),
	 ('202200','Fabricación de pinturas, barnices y productos de revestimiento similares, tintas de imprenta y masillas','Fabricación de pinturas, barnices y productos de revestimiento similares, tintas de imprenta y masillas'),
	 ('202311','Fabricación de preparados para limpieza, pulido y saneamiento','Fabricación de preparados para limpieza, pulido y saneamiento '),
	 ('202312','Fabricación de jabones y detergentes','Fabricación de jabones y detergentes'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('210010','Fabricación de medicamentos de uso humano y productos farmacéuticos','Fabricación de medicamentos de uso humano y productos farmacéuticos'),
	 ('210020','Fabricación de medicamentos de uso veterinario','Fabricación de medicamentos de uso veterinario'),
	 ('210030','Fabricación de sustancias químicas para la elaboración de medicamentos','Fabricación de sustancias químicas para la elaboración de medicamentos'),
	 ('210090','Fabricación de productos de laboratorio y productos botánicos de uso farmaceútico n.c.p.','Fabricación de productos de laboratorio y productos botánicos de uso farmaceútico n.c.p.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('231010','Fabricación de envases de vidrio','Fabricación de envases de vidrio'),
	 ('231020','Fabricación y elaboración de vidrio plano','Fabricación y elaboración de vidrio plano'),
	 ('231090','Fabricación de productos de vidrio n.c.p.','Fabricación de productos de vidrio n.c.p.'),
	 ('239100','Fabricación de productos de cerámica refractaria','Fabricación de productos de cerámica refractaria'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('239410','Elaboración de cemento','Elaboración de cemento'),
	 ('239421','Elaboración de  yeso','Elaboración de  yeso'),
	 ('239422','Elaboración de cal','Elaboración de cal'),
	 ('239510','Fabricación de mosaicos','Fabricación de mosaicos'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('241009','Fabricación en industrias básicas de productos de hierro y acero n.c.p.','Fabricación en industrias básicas de productos de hierro y acero n.c.p. (Incluye la producción de hojalata)'),
	 ('242010','Elaboración de aluminio primario y semielaborados de aluminio','Elaboración de aluminio primario y semielaborados de aluminio'),
	 ('242090','Fabricación de productos primarios de metales preciosos y metales no ferrosos n.c.p. y sus semielaborados','Fabricación de productos primarios de metales preciosos y metales no ferrosos n.c.p. y sus semielaborados'),
	 ('243100','Fundición de hierro y acero','Fundición de hierro y acero'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('259100','Forjado, prensado, estampado y laminado de metales, pulvimetalurgia','Forjado, prensado, estampado y laminado de metales, pulvimetalurgia'),
	 ('259200','Tratamiento y revestimiento de metales y trabajos de metales en general','Tratamiento y revestimiento de metales y trabajos de metales en general '),
	 ('259301','Fabricación de herramientas manuales y sus accesorios','Fabricación de herramientas manuales y sus accesorios'),
	 ('259302','Fabricación de artículos de cuchillería y utensillos de mesa y de cocina','Fabricación de artículos de cuchillería y utensillos de mesa y de cocina'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('261000','Fabricación de componentes electrónicos','Fabricación de componentes electrónicos '),
	 ('262000','Fabricación de equipos y productos informáticos','Fabricación de equipos y productos informáticos'),
	 ('263000','Fabricación  de equipos de comunicaciones y transmisores de radio y televisión','Fabricación  de equipos de comunicaciones y transmisores de radio y televisión'),
	 ('264000','Fabricación de receptores de radio y televisión, aparatos de grabación y reproducción de sonido y video, y productos conexos','Fabricación de receptores de radio y televisión, aparatos de grabación y reproducción de sonido y video, y productos conexos'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('267002','Fabricación de aparatos y accesorios para fotografía excepto películas, placas y papeles sensibles','Fabricación de aparatos y accesorios para fotografía excepto películas, placas y papeles sensibles'),
	 ('268000','Fabricación de soportes ópticos y magnéticos','Fabricación de soportes ópticos y magnéticos (Incluye CD, disquetes, cintas magnéticas, tarjetas magnetizadas, etc.)'),
	 ('271010','Fabricación de motores, generadores y transformadores eléctricos','Fabricación de motores, generadores y transformadores eléctricos'),
	 ('271020','Fabricación de aparatos de distribución y control de la energía eléctrica','Fabricación de aparatos de distribución y control de la energía eléctrica'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('275091','Fabricación de ventiladores, extractores de aire, aspiradoras y similares','Fabricación de ventiladores, extractores de aire, aspiradoras y similares'),
	 ('275092','Fabricación de planchas, calefactores, hornos eléctricos, tostadoras y otros aparatos generadores de calor','Fabricación de planchas, calefactores, hornos eléctricos, tostadoras y otros aparatos generadores de calor'),
	 ('275099','Fabricación de aparatos de uso doméstico n.c.p.','Fabricación de aparatos de uso doméstico n.c.p. (Incluye enceradoras, pulidoras, batidoras, licuadoras y similares)'),
	 ('279000','Fabricación  de equipo eléctrico n.c.p.','Fabricación  de equipo eléctrico n.c.p.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('281700','Fabricación de maquinaria y equipo de oficina, excepto equipo informático','Fabricación de maquinaria y equipo de oficina, excepto equipo informático'),
	 ('281900','Fabricación de  maquinaria y equipo de uso general n.c.p.','Fabricación de  maquinaria y equipo de uso general n.c.p. (Incluye la fabricación de equipos de aire acondicionado, matafuegos, etc.)'),
	 ('282110','Fabricación de tractores','Fabricación de tractores'),
	 ('282120','Fabricación de maquinaria y equipo de uso agropecuario y forestal','Fabricación de maquinaria y equipo de uso agropecuario y forestal'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('282901','Fabricación de maquinaria para la industria del papel y las artes gráficas','Fabricación de maquinaria para la industria del papel y las artes gráficas'),
	 ('282909','Fabricación de maquinaria y equipo de uso especial n.c.p.','Fabricación de maquinaria y equipo de uso especial n.c.p.'),
	 ('291000','Fabricación de vehículos automotores','Fabricación de vehículos automotores (Incluye la fabricación de motores para automotores)'),
	 ('292000','Fabricación de carrocerías para vehículos automotores, fabricación de remolques y semirremolques','Fabricación de carrocerías para vehículos automotores, fabricación de remolques y semirremolques'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('309100','Fabricación de motocicletas','Fabricación de motocicletas'),
	 ('309200','Fabricación de bicicletas y de sillones de ruedas ortopédicos','Fabricación de bicicletas y de sillones de ruedas ortopédicos'),
	 ('309900','Fabricación de equipo de transporte n.c.p.','Fabricación de equipo de transporte n.c.p.'),
	 ('310010','Fabricación de muebles y partes de muebles, principalmente de madera','Fabricación de muebles y partes de muebles, principalmente de madera'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('323001','Fabricación de artículos de deporte','Fabricación de artículos de deporte (Incluye equipos de deporte para gimnasia y campos de juegos, equipos de pesca y camping, etc., excepto indumentaria deportiva: 141040)'),
	 ('324000','Fabricación de juegos y juguetes','Fabricación de juegos y juguetes'),
	 ('329010','Fabricación de lápices, lapiceras,  bolígrafos, sellos y artículos similares para oficinas y artistas','Fabricación de lápices, lapiceras,  bolígrafos, sellos y artículos similares para oficinas y artistas'),
	 ('329020','Fabricación de escobas, cepillos y pinceles','Fabricación de escobas, cepillos y pinceles '),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('331290','Reparación y mantenimiento de maquinaria de uso especial n.c.p.','Reparación y mantenimiento de maquinaria de uso especial n.c.p.'),
	 ('331400','Reparación y mantenimiento de maquinaria y aparatos eléctricos','Reparación y mantenimiento de maquinaria y aparatos eléctricos '),
	 ('331900','Reparación y mantenimiento de máquinas y equipo n.c.p.','Reparación y mantenimiento de máquinas y equipo n.c.p.'),
	 ('332000','Instalación de maquinaria y equipos industriales','Instalación de maquinaria y equipos industriales'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('351320','Distribución de energía eléctrica','Distribución de energía eléctrica'),
	 ('352010','Fabricación de gas y procesamiento de gas natural','Fabricación de gas y procesamiento de gas natural'),
	 ('352020','Distribución de combustibles gaseosos por tuberías','Distribución de combustibles gaseosos por tuberías (No incluye el transporte por gasoductos)'),
	 ('353001','Suministro de vapor y aire acondicionado','Suministro de vapor y aire acondicionado'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('382020','Recuperación de materiales y desechos no metálicos','Recuperación de materiales y desechos no metálicos'),
	 ('390000','Descontaminación y otros servicios de gestión de residuos','Descontaminación y otros servicios de gestión de residuos'),
	 ('410011','Construcción, reforma y reparación de edificios residenciales','Construcción, reforma y reparación de edificios residenciales (Incluye la construcción, reforma y reparación  de viviendas unifamiliares y multifamiliares, bungaloes, cabañas, casas de campo, departamentos, albergues para ancianos, niños, estudiantes, etc.)'),
	 ('410021','Construcción, reforma y reparación de edificios no residenciales','Construcción, reforma y reparación de edificios no residenciales (Incluye construcción, reforma y reparación de restaurantes, bares, campamentos, bancos, oficinas, galerías comerciales, estaciones de servicio, edificios para tráfico y comunicaciones, garajes, edificios industriales y depósitos, escuelas, etc.)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('431210','Movimiento de suelos y preparación de terrenos para obras','Movimiento de suelos y preparación de terrenos para obras (Incluye el drenaje, excavación de zanjas para construcciones diversas, el despeje de capas superficiales no contaminadas, movimientos de tierras para hacer terraplenes o desmontes previos a la construcción de vías, carreteras, autopistas, FFCC, etc.)'),
	 ('432110','Instalación de sistemas de iluminación, control y señalización eléctrica para el transporte','Instalación de sistemas de iluminación, control y señalización eléctrica para el transporte '),
	 ('432190','Instalación, ejecución y mantenimiento de instalaciones eléctricas, electromecánicas y electrónicas n.c.p.','Instalación, ejecución y mantenimiento de instalaciones eléctricas, electromecánicas y electrónicas n.c.p. (Incluye la instalación de antenas, pararrayos, sistemas de alarmas contra incendios y robos, sistemas de telecomunicación, etc.)'),
	 ('432200','Instalaciones de gas, agua, sanitarios y de climatización, con sus artefactos conexos','Instalaciones de gas, agua, sanitarios y de climatización, con sus artefactos conexos (Incluye la instalación de compactadores, calderas, sistemas de calefacción central, etc.)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('433040','Pintura y trabajos de decoración','Pintura y trabajos de decoración'),
	 ('433090','Terminación de edificios n.c.p.','Terminación de edificios n.c.p. (Incluye trabajos de ornamentación, limpieza exterior de edificios recién construídos, etc.)'),
	 ('439100','Alquiler de equipo de construcción o demolición dotado de operarios','Alquiler de equipo de construcción o demolición dotado de operarios'),
	 ('439910','Hincado de pilotes, cimentación y otros trabajos de hormigón armado','Hincado de pilotes, cimentación y otros trabajos de hormigón armado'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('452210','Reparación de cámaras y cubiertas','Reparación de cámaras y cubiertas (Incluye reparación de llantas) '),
	 ('452220','Reparación de amortiguadores,  alineación de dirección y balanceo de ruedas','Reparación de amortiguadores,  alineación de dirección y balanceo de ruedas '),
	 ('452300','Instalación y reparación de parabrisas, lunetas y ventanillas, cerraduras no eléctricas y grabado de cristales','Instalación y reparación de parabrisas, lunetas y ventanillas, cerraduras no eléctricas y grabado de cristales (Incluye instalación y reparación de aletas, burletes y colisas)'),
	 ('452401','Reparaciones eléctricas del tablero e instrumental, reparación y recarga de baterías, instalación de alarmas, radios, sistemas de climatización','Reparaciones eléctricas del tablero e instrumental, reparación y recarga de baterías, instalación de alarmas, radios, sistemas de climatización'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('453100','Venta al por mayor de partes, piezas y accesorios de vehículos automotores','Venta al por mayor de partes, piezas y accesorios de vehículos automotores'),
	 ('453210','Venta al por menor de cámaras y cubiertas','Venta al por menor de cámaras y cubiertas'),
	 ('453220','Venta al por menor de baterías','Venta al por menor de baterías'),
	 ('453291','Venta al por menor de partes, piezas y accesorios nuevos n.c.p.','Venta al por menor de partes, piezas y accesorios nuevos n.c.p.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('461014','Acopio y acondicionamiento en comisión o consignación de cereales (incluye arroz), oleaginosas y forrajeras excepto semillas','Acopio y acondicionamiento en comisión o consignación de cereales (incluye arroz), oleaginosas y forrajeras excepto semillas'),
	 ('461019','Venta al por mayor en comisión o consignación de productos agrícolas n.c.p.','Venta al por mayor en comisión o consignación de productos agrícolas n.c.p.'),
	 ('461021','Venta al por mayor en comisión o consignación de ganado bovino en pie','Venta al por mayor en comisión o consignación de ganado bovino en pie (Incluye consignatarios de hacienda y ferieros)'),
	 ('461022','Venta al por mayor en comisión o consignación de ganado en pie excepto bovino','Venta al por mayor en comisión o consignación de ganado en pie excepto bovino'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('461093','Venta al por mayor en comisión o consignación de minerales, metales y productos químicos industriales','Venta al por mayor en comisión o consignación de minerales, metales y productos químicos industriales'),
	 ('461094','Venta al por mayor en comisión o consignación de  maquinaria, equipo profesional industrial y comercial, embarcaciones y aeronaves','Venta al por mayor en comisión o consignación de  maquinaria, equipo profesional industrial y comercial, embarcaciones y aeronaves'),
	 ('461095','Venta al por mayor en comisión o consignación de papel, cartón, libros, revistas, diarios, materiales de embalaje y artículos de librería','Venta al por mayor en comisión o consignación de papel, cartón, libros, revistas, diarios, materiales de embalaje y artículos de librería'),
	 ('461099','Venta al por mayor en comisión o consignación de  mercaderías n.c.p.','Venta al por mayor en comisión o consignación de  mercaderías n.c.p.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('462209','Venta al por mayor de materias primas pecuarias n.c.p. incluso animales vivos','Venta al por mayor de materias primas pecuarias n.c.p. incluso animales vivos (Incluye pieles y cueros en bruto)'),
	 ('463111','Venta al por mayor de productos lácteos','Venta al por mayor de productos lácteos'),
	 ('463112','Venta al por mayor de fiambres y quesos','Venta al por mayor de fiambres y quesos'),
	 ('463121','Venta al por mayor de carnes rojas y derivados','Venta al por mayor de carnes rojas y derivados (Incluye abastecedores y distribuidores de carne)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('463154','Venta al por mayor de café, té, yerba mate y otras infusiones y especias y condimentos','Venta al por mayor de café, té, yerba mate y otras infusiones y especias y condimentos (Incluye la venta de sal)'),
	 ('463159','Venta al por mayor de productos y subproductos de molinería n.c.p.','Venta al por mayor de productos y subproductos de molinería n.c.p.'),
	 ('463160','Venta al por mayor de chocolates, golosinas y productos para kioscos y polirrubros n.c.p., excepto cigarrillos','Venta al por mayor de chocolates, golosinas y productos para kioscos y polirrubros n.c.p., excepto cigarrillos'),
	 ('463170','Venta al por mayor de alimentos balanceados para animales','Venta al por mayor de alimentos balanceados para animales'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('463220','Venta al por mayor de bebidas no alcohólicas','Venta al por mayor de bebidas no alcohólicas (Incluye la venta de aguas, sodas, bebidas refrescantes, jarabes, extractos, concentrados, gaseosas, jugos, etc.)'),
	 ('463300','Venta al por mayor de cigarrillos y productos de tabaco','Venta al por mayor de cigarrillos y productos de tabaco'),
	 ('464111','Venta al por mayor de tejidos (telas)','Venta al por mayor de tejidos (telas)'),
	 ('464112','Venta al por mayor de artículos de mercería','Venta al por mayor de artículos de mercería (Incluye la venta de puntillas, galones, hombreras, agujas, botones, etc.)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('464130','Venta al por mayor de calzado excepto el ortopédico','Venta al por mayor de calzado excepto el ortopédico (Incluye venta de calzado de cuero, tela, plástico, goma, etc.)'),
	 ('464141','Venta al por mayor de pieles y cueros curtidos y salados','Venta al por mayor de pieles y cueros curtidos y salados'),
	 ('464142','Venta al por mayor de suelas y afines','Venta al por mayor de suelas y afines (Incluye talabarterías, artículos regionales de cuero, almacenes de suelas, etc.)'),
	 ('464149','Venta al por mayor de artículos de marroquinería,  paraguas y productos similares n.c.p.','Venta al por mayor de artículos de marroquinería,  paraguas y productos similares n.c.p.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('464310','Venta al por mayor de productos farmacéuticos','Venta al por mayor de productos farmacéuticos (Incluye venta de medicamentos y kits de diagnóstico como test de embarazo, hemoglucotest, vacunas, etc.)'),
	 ('464320','Venta al por mayor de productos cosméticos, de tocador y de perfumería','Venta al por mayor de productos cosméticos, de tocador y de perfumería (Incluye venta de artículos para peluquería excepto equipamiento)'),
	 ('464330','Venta al por mayor de instrumental médico y odontológico y artículos ortopédicos','Venta al por mayor de instrumental médico y odontológico y artículos ortopédicos (Incluye venta de vaporizadores, nebulizadores, masajeadores, termómetros, prótesis, muletas, plantillas, calzado ortopédico y otros artículos similares de uso personal o doméstico)'),
	 ('464340','Venta al por mayor de productos veterinarios','Venta al por mayor de productos veterinarios'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('464631','Venta al por mayor de artículos de vidrio','Venta al por mayor de artículos de vidrio'),
	 ('464632','Venta al por mayor de artículos de bazar y menaje excepto de vidrio','Venta al por mayor de artículos de bazar y menaje excepto de vidrio'),
	 ('464920','Venta al por mayor de materiales y productos de limpieza','Venta al por mayor de materiales y productos de limpieza'),
	 ('464930','Venta al por mayor de juguetes','Venta al por mayor de juguetes (Incluye artículos de cotillón)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('465220','Venta al por mayor de componentes electrónicos','Venta al por mayor de componentes electrónicos'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('465610','Venta al por mayor de muebles e instalaciones para oficinas','Venta al por mayor de muebles e instalaciones para oficinas'),
	 ('465690','Venta al por mayor de muebles e instalaciones para la industria, el comercio y los servicios n.c.p.','Venta al por mayor de muebles e instalaciones para la industria, el comercio y los servicios n.c.p.'),
	 ('465910','Venta al por mayor de máquinas y equipo de control y seguridad','Venta al por mayor de máquinas y equipo de control y seguridad'),
	 ('465920','Venta al por mayor de maquinaria y equipo de oficina, excepto equipo informático','Venta al por mayor de maquinaria y equipo de oficina, excepto equipo informático'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('466310','Venta al por mayor de aberturas','Venta al por mayor de aberturas (Incluye puertas, ventanas, cortinas de enrollar, madera, aluminio, puertas corredizas, frentes de placard, etc.)'),
	 ('466320','Venta al por mayor de productos de madera excepto muebles','Venta al por mayor de productos de madera excepto muebles (Incluye placas, varillas, parqué, machimbre, etc.)'),
	 ('466330','Venta al por mayor de artículos de ferretería y materiales eléctricos','Venta al por mayor de artículos de ferretería y materiales eléctricos (Incluye la venta  de clavos, cerraduras, cable coaxil. etc)'),
	 ('466340','Venta al por mayor de pinturas y productos conexos','Venta al por mayor de pinturas y productos conexos'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('466920','Venta al por mayor de productos intermedios n.c.p., desperdicios y desechos de papel y cartón','Venta al por mayor de productos intermedios n.c.p., desperdicios y desechos de papel y cartón'),
	 ('466931','Venta al por mayor de artículos de plástico','Venta al por mayor de artículos de plástico '),
	 ('466932','Venta al por mayor de abonos, fertilizantes y plaguicidas','Venta al por mayor de abonos, fertilizantes y plaguicidas'),
	 ('466939','Venta al por mayor de productos intermedios, desperdicios y desechos de vidrio, caucho, goma y químicos n.c.p.','Venta al por mayor de productos intermedios, desperdicios y desechos de vidrio, caucho, goma y químicos n.c.p.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('471130','Venta al por menor en minimercados','Venta al por menor en minimercados (Incluye mercaditos, autoservicios y establecimientos similares que vendan carnes, verduras y demás productos alimenticios en forma conjunta)'),
	 ('471190','Venta al por menor en kioscos, polirrubros y comercios no especializados n.c.p.','Venta al por menor en kioscos, polirrubros y comercios no especializados n.c.p.'),
	 ('471900','Venta al por menor en comercios no especializados, sin predominio de productos alimenticios y bebidas','Venta al por menor en comercios no especializados, sin predominio de productos alimenticios y bebidas'),
	 ('472111','Venta al por menor de productos lácteos','Venta al por menor de productos lácteos'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('472171','Venta al por menor de pan y productos de panadería','Venta al por menor de pan y productos de panadería   '),
	 ('472172','Venta al por menor de bombones, golosinas y demás productos de confitería','Venta al por menor de bombones, golosinas y demás productos de confitería'),
	 ('472190','Venta al por menor de productos alimenticios n.c.p., en comercios especializados','Venta al por menor de productos alimenticios n.c.p., en comercios especializados'),
	 ('472200','Venta al por menor de bebidas en comercios especializados','Venta al por menor de bebidas en comercios especializados'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('475190','Venta al por menor de artículos textiles n.c.p. excepto prendas de vestir','Venta al por menor de artículos textiles n.c.p. excepto prendas de vestir (Incluye la venta al por menor de tapices, alfombras,  etc.)'),
	 ('475210','Venta al por menor de aberturas','Venta al por menor de aberturas (Incluye puertas, ventanas, cortinas de enrollar de PVC, madera, aluminio, puertas corredizas, frentes de placards, etc.)'),
	 ('475220','Venta al por menor de maderas y artículos de madera  y corcho, excepto muebles','Venta al por menor de maderas y artículos de madera  y corcho, excepto muebles'),
	 ('475230','Venta al por menor de artículos de ferretería y materiales eléctricos','Venta al por menor de artículos de ferretería y materiales eléctricos'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('475410','Venta al por menor de muebles para el hogar, artículos de mimbre y corcho','Venta al por menor de muebles para el hogar, artículos de mimbre y corcho'),
	 ('475420','Venta al por menor de colchones y somieres','Venta al por menor de colchones y somieres'),
	 ('475430','Venta al por menor de artículos de iluminación','Venta al por menor de artículos de iluminación '),
	 ('475440','Venta al por menor de artículos de bazar y menaje','Venta al por menor de artículos de bazar y menaje (Incluye venta al por menor de vajilla, cubiertos, etc.)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('476400','Venta al por menor de juguetes, artículos de cotillón y juegos de mesa','Venta al por menor de juguetes, artículos de cotillón y juegos de mesa'),
	 ('477110','Venta al por menor de ropa interior, medias, prendas para dormir y para la playa','Venta al por menor de ropa interior, medias, prendas para dormir y para la playa (Incluye corsetería, lencería, camisetas, medias excepto ortopédicas, pijamas, camisones y saltos de cama, salidas de baño, trajes de baño, etc.)'),
	 ('477120','Venta al por menor de uniformes escolares y guardapolvos','Venta al por menor de uniformes escolares y guardapolvos'),
	 ('477130','Venta al por menor de indumentaria para bebés y niños','Venta al por menor de indumentaria para bebés y niños'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('477290','Venta al por menor de artículos de marroquinería, paraguas y similares n.c.p.','Venta al por menor de artículos de marroquinería, paraguas y similares n.c.p.'),
	 ('477310','Venta al por menor de productos farmacéuticos y de herboristería','Venta al por menor de productos farmacéuticos y de herboristería'),
	 ('477320','Venta al por menor de productos cosméticos, de tocador y de perfumería','Venta al por menor de productos cosméticos, de tocador y de perfumería'),
	 ('477330','Venta al por menor de instrumental médico y odontológico y artículos ortopédicos','Venta al por menor de instrumental médico y odontológico y artículos ortopédicos (Incluye venta de vaporizadores, nebulizadores, masajeadores, termómetros, prótesis, muletas, plantillas, calzado ortopédico y otros artículos similares de uso personal o doméstico)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('477470','Venta al por menor de productos veterinarios, animales domésticos y alimento balanceado para mascotas','Venta al por menor de productos veterinarios, animales domésticos y alimento balanceado para mascotas'),
	 ('477480','Venta al por menor de obras de arte','Venta al por menor de obras de arte'),
	 ('477490','Venta al por menor de artículos nuevos n.c.p.','Venta al por menor de artículos nuevos n.c.p. (Incluye la venta realizada en casas de regalos, de artesanías, pelucas,  de artículos religiosos -santerías-, recarga de matafuegos,  etc.) '),
	 ('477810','Venta al por menor de muebles usados','Venta al por menor de muebles usados'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('479101','Venta al por menor por internet','Venta al por menor por internet '),
	 ('479109','Venta al por menor por correo, televisión y otros medios de comunicación n.c.p.','Venta al por menor por correo, televisión y otros medios de comunicación n.c.p.'),
	 ('479900','Venta al por menor no realizada en establecimientos  n.c.p.','Venta al por menor no realizada en establecimientos  n.c.p. (Incluye venta mediante máquinas expendedoras, vendedores ambulantes y vendedores a domicilio)'),
	 ('491110','Servicio de transporte ferroviario urbano y suburbano de pasajeros','Servicio de transporte ferroviario urbano y suburbano de pasajeros (Incluye el servicio de subterráneo y de premetro)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('492150','Servicio de transporte automotor interurbano regular de pasajeros, E1203excepto transporte internacional','Servicio de transporte automotor interurbano regular de pasajeros, E1203excepto transporte internacional (Incluye los llamados servicios de larga distancia)'),
	 ('492160','Servicio de transporte automotor interurbano no regular de pasajeros','Servicio de transporte automotor interurbano no regular de pasajeros '),
	 ('492170','Servicio de transporte automotor internacional de pasajeros','Servicio de transporte automotor internacional de pasajeros '),
	 ('492180','Servicio de transporte automotor turístico de pasajeros','Servicio de transporte automotor turístico de pasajeros '),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('492250','Servicio de transporte automotor de mercaderías y sustancias peligrosas','Servicio de transporte automotor de mercaderías y sustancias peligrosas'),
	 ('492280','Servicio de transporte automotor urbano de carga n.c.p.','Servicio de transporte automotor urbano de carga n.c.p. (Incluye el transporte realizado por fleteros y distribuidores dentro del égido urbano)'),
	 ...
	 ('493110','Servicio de transporte por oleoductos','Servicio de transporte por oleoductos (Incluye estaciones de bombeo y compresión)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('511000','Servicio de transporte aéreo de pasajeros','Servicio de transporte aéreo de pasajeros'),
	 ('512000','Servicio de transporte aéreo de cargas','Servicio de transporte aéreo de cargas'),
	 ('521010','Servicios de manipulación de carga en el ámbito terrestre','Servicios de manipulación de carga en el ámbito terrestre'),
	 ('521020','Servicios de manipulación de carga en el ámbito portuario','Servicios de manipulación de carga en el ámbito portuario'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('523011','Servicios de gestión aduanera realizados por despachantes de aduana','Servicios de gestión aduanera realizados por despachantes de aduana'),
	 ('523019','Servicios de gestión aduanera para el transporte de mercaderías n.c.p.','Servicios de gestión aduanera para el transporte de mercaderías n.c.p.'),
	 ('523020','Servicios de agencias marítimas para el transporte de mercaderías','Servicios de agencias marítimas para el transporte de mercaderías'),
	 ('523031','Servicios de gestión de agentes de transporte aduanero excepto agencias marítimas','Servicios de gestión de agentes de transporte aduanero excepto agencias marítimas'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('524190','Servicios complementarios para el transporte terrestre n.c.p.','Servicios complementarios para el transporte terrestre n.c.p. (Incluye servicios de mantenimiento de material ferroviario)'),
	 ('524210','Servicios de explotación de infraestructura para el transporte marítimo, derechos de puerto','Servicios de explotación de infraestructura para el transporte marítimo, derechos de puerto'),
	 ('524220','Servicios de guarderías náuticas','Servicios de guarderías náuticas'),
	 ('524230','Servicios para la navegación','Servicios para la navegación (Incluye servicios de practicaje y pilotaje, atraque y salvamento)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('530090','Servicios de mensajerías.','Servicios de mensajerías (Incluye servicios puerta a puerta de correo y mensajería, comisionistas de encomiendas, transporte de documentos  realizados por empresas no sujetas a la obligación de servicio universal)'),
	 ('551010','Servicios de alojamiento por hora','Servicios de alojamiento por hora '),
	 ('551021','Servicios de alojamiento en pensiones','Servicios de alojamiento en pensiones'),
	 ('551022','Servicios de alojamiento en hoteles, hosterías y residenciales similares, excepto por hora, que incluyen servicio de restaurante al público','Servicios de alojamiento en hoteles, hosterías y residenciales similares, excepto por hora, que incluyen servicio de restaurante al público'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('561014','Servicios de expendio de bebidas en bares','Servicios de expendio de bebidas en bares (Incluye: bares, cervecerías, pubs, cafeterías)'),
	 ('561019','Servicios de expendio de comidas y bebidas en establecimientos con servicio de mesa y/o en mostrador n.c.p.','Servicios de expendio de comidas y bebidas en establecimientos con servicio de mesa y/o en mostrador n.c.p.'),
	 ('561020','Servicios de preparación de comidas para llevar','Servicios de preparación de comidas para llevar (Incluye rotiserías, casas de empanadas, pizzerías sin consumo en el local) '),
	 ('561030','Servicio de expendio de helados','Servicio de expendio de helados'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('581300','Edición de periódicos, revistas y publicaciones periódicas','Edición de periódicos, revistas y publicaciones periódicas'),
	 ('581900','Edición n.c.p.','Edición n.c.p.'),
	 ('591110','Producción de filmes y videocintas','Producción de filmes y videocintas'),
	 ('591120','Postproducción de filmes y videocintas','Postproducción de filmes y videocintas'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('602310','Emisión de señales de televisión por suscripción','Emisión de señales de televisión por suscripción'),
	 ('602320','Producción de programas de televisión','Producción de programas de televisión'),
	 ('602900','Servicios de televisión n.c.p','Servicios de televisión n.c.p'),
	 ('611010','Servicios de locutorios','Servicios de locutorios'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('620100','Servicios de consultores en informática y suministros de programas de informática','Servicios de consultores en informática y suministros de programas de informática'),
	 ('620200','Servicios de consultores en equipo de informática','Servicios de consultores en equipo de informática '),
	 ('620300','Servicios de consultores en tecnología de la información','Servicios de consultores en tecnología de la información'),
	 ('620900','Servicios de informática n.c.p.','Servicios de informática n.c.p.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('641100','Servicios de la banca central','Servicios de la banca central (Incluye las actividades del Banco Central de la República Argentina)'),
	 ('641910','Servicios de la banca mayorista','Servicios de la banca mayorista'),
	 ('641920','Servicios de la banca de inversión','Servicios de la banca de inversión'),
	 ('641930','Servicios de la banca minorista','Servicios de la banca minorista'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('649100','Arrendamiento financiero, leasing','Arrendamiento financiero, leasing'),
	 ('649210','Actividades de crédito para financiar otras actividades económicas','Actividades de crédito para financiar otras actividades económicas '),
	 ('649220','Servicios de entidades de tarjeta de compra y/o crédito','Servicios de entidades de tarjeta de compra y/o crédito'),
	 ('649290','Servicios de crédito n.c.p.','Servicios de crédito n.c.p. (Incluye el otorgamiento de préstamos por entidades que no reciben depósitos y que están fuera del sistema bancario y cuyo destino es financiar el consumo, la vivienda u otros bienes)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('651210','Servicios de aseguradoras de riesgo de trabajo (ART)','Servicios de aseguradoras de riesgo de trabajo (ART)'),
	 ('651220','Servicios de seguros patrimoniales excepto los de las aseguradoras de riesgo de trabajo (ART)','Servicios de seguros patrimoniales excepto los de las aseguradoras de riesgo de trabajo (ART)'),
	 ('651310','Obras Sociales','Obras Sociales'),
	 ('651320','Servicios de cajas de previsión social pertenecientes a asociaciones profesionales','Servicios de cajas de previsión social pertenecientes a asociaciones profesionales '),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('661920','Servicios de casas y agencias de cambio','Servicios de casas y agencias de cambio'),
	 ('661930','Servicios de sociedades calificadoras de riesgos financieros','Servicios de sociedades calificadoras de riesgos financieros'),
	 ('661991','Servicios de envio y recepción de fondos desde y hacia el exterior','Servicios de envio y recepción de fondos desde y hacia el exterior'),
	 ('661992','Servicios de administradoras de vales y tickets','Servicios de administradoras de vales y tickets '),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('681020','Servicios de alquiler  de consultorios médicos','Servicios de alquiler  de consultorios médicos'),
	 ('681098','Servicios inmobiliarios realizados por cuenta propia, con bienes urbanos propios o arrendados n.c.p.','Servicios inmobiliarios realizados por cuenta propia, con bienes urbanos propios o arrendados n.c.p.'),
	 ('681099','Servicios inmobiliarios realizados por cuenta propia, con bienes rurales propios o arrendados n.c.p.','Servicios inmobiliarios realizados por cuenta propia, con bienes rurales propios o arrendados n.c.p.'),
	 ('682010','Servicios de administración de consorcios de edificios','Servicios de administración de consorcios de edificios'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('702092','Servicios de asesoramiento, dirección y gestión empresarial realizados por integrantes de cuerpos de dirección en sociedades excepto las anónimas','Servicios de asesoramiento, dirección y gestión empresarial realizados por integrantes de cuerpos de dirección en sociedades excepto las anónimas'),
	 ('702099','Servicios de asesoramiento, dirección y gestión empresarial n.c.p.','Servicios de asesoramiento, dirección y gestión empresarial n.c.p.'),
	 ('711001','Servicios relacionados con la construcción.','Servicios relacionados con la construcción (Incluye los servicios prestados por ingenieros, arquitectos y técnicos)'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('721030','Investigación  y desarrollo experimental en el campo de las ciencias agropecuarias','Investigación  y desarrollo experimental en el campo de las ciencias agropecuarias'),
	 ('721090','Investigación y desarrollo experimental en el campo de las ciencias exactas y naturales n.c.p.','Investigación y desarrollo experimental en el campo de las ciencias exactas y naturales n.c.p.'),
	 ('722010','Investigación  y desarrollo experimental en el campo de las ciencias sociales','Investigación  y desarrollo experimental en el campo de las ciencias sociales'),
	 ('722020','Investigación  y desarrollo experimental en el campo de las ciencias humanas','Investigación  y desarrollo experimental en el campo de las ciencias humanas'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('749002','Servicios de representación e intermediación de artistas y modelos','Servicios de representación e intermediación de artistas y modelos'),
	 ('749003','Servicios de representación e intermediación de deportistas profesionales','Servicios de representación e intermediación de deportistas profesionales'),
	 ('749009','Actividades profesionales, científicas y técnicas n.c.p.','Actividades profesionales, científicas y técnicas n.c.p.'),
	 ('750000','Servicios veterinarios','Servicios veterinarios'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('772091','Alquiler de prendas de vestir','Alquiler de prendas de vestir'),
	 ('772099','Alquiler de efectos personales y enseres domésticos n.c.p.','Alquiler de efectos personales y enseres domésticos n.c.p. (Incluye alquiler de artículos deportivos)'),
	 ('773010','Alquiler de maquinaria y equipo agropecuario y forestal, sin operarios','Alquiler de maquinaria y equipo agropecuario y forestal, sin operarios'),
	 ('773020','Alquiler de maquinaria y equipo para la minería, sin operarios','Alquiler de maquinaria y equipo para la minería, sin operarios'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('791200','Servicios mayoristas de agencias de viajes','Servicios mayoristas de agencias de viajes'),
	 ('791901','Servicios de turismo aventura','Servicios de turismo aventura'),
	 ('791909','Servicios complementarios de apoyo turístico n.c.p.','Servicios complementarios de apoyo turístico n.c.p.'),
	 ('801010','Servicios de transporte de caudales y objetos de valor','Servicios de transporte de caudales y objetos de valor'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('813000','Servicios de jardinería y mantenimiento de espacios verdes','Servicios de jardinería y mantenimiento de espacios verdes'),
	 ('821100','Servicios combinados de gestión administrativa de oficinas','Servicios combinados de gestión administrativa de oficinas'),
	 ('821900','Servicios de fotocopiado, preparación de documentos y otros servicios de apoyo de oficina','Servicios de fotocopiado, preparación de documentos y otros servicios de apoyo de oficina'),
	 ('822000','Servicios de call center','Servicios de call center'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('852100','Enseñanza secundaria de formación general','Enseñanza secundaria de formación general'),
	 ('852200','Enseñanza secundaria de formación técnica y profesional','Enseñanza secundaria de formación técnica y profesional'),
	 ('853100','Enseñanza  terciaria','Enseñanza  terciaria'),
	 ('853201','Enseñanza universitaria excepto formación de posgrado','Enseñanza universitaria excepto formación de posgrado'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('854960','Enseñanza artística','Enseñanza artística'),
	 ('854990','Servicios de enseñanza n.c.p.','Servicios de enseñanza n.c.p. (Incluye instrucción impartida mediante programas de radio, televisión, correspondencia y otros medios de comunicación, escuelas de manejo, actividades de enseñanza a domicilio y/o particulares, etc.)'),
	 ('855000','Servicios de apoyo a la educación','Servicios de apoyo a la educación'),
	 ('861010','Servicios de internación excepto instituciones relacionadas con la salud mental','Servicios de internación excepto instituciones relacionadas con la salud mental'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('863120','Servicios de prácticas de diagnóstico por imágenes','Servicios de prácticas de diagnóstico por imágenes (Incluye radiología, ecografía, resonancia magnética, etc.)'),
	 ('863190','Servicios de prácticas de diagnóstico n.c.p.','Servicios de prácticas de diagnóstico n.c.p.'),
	 ('863200','Servicios de tratamiento','Servicios de tratamiento (Incluye hemodiálisis, cobaltoterapia, etc) '),
	 ('863300','Servicio médico integrado de consulta, diagnóstico y tratamiento','Servicio médico integrado de consulta, diagnóstico y tratamiento'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('870910','Servicios de atención a niños y adolescentes carenciados con alojamiento','Servicios de atención a niños y adolescentes carenciados con alojamiento'),
	 ('870920','Servicios de atención a mujeres con alojamiento','Servicios de atención a mujeres con alojamiento'),
	 ('870990','Servicios sociales con alojamiento n.c.p.','Servicios sociales con alojamiento n.c.p.'),
	 ('880000','Servicios sociales sin alojamiento','Servicios sociales sin alojamiento '),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('910200','Servicios de museos y preservación de lugares y edificios históricos','Servicios de museos y preservación de lugares y edificios históricos'),
	 ('910300','Servicios de jardines botánicos, zoológicos y de parques nacionales','Servicios de jardines botánicos, zoológicos y de parques nacionales'),
	 ('910900','Servicios culturales n.c.p.','Servicios culturales n.c.p. (Incluye actividades sociales, culturales, recreativas y de interés local desarrollado por centros vecinales, barriales, sociedades de fomento, clubes no deportivos, etc.)'),
	 ('920001','Servicios de recepción de apuestas de quiniela, lotería y similares','Servicios de recepción de apuestas de quiniela, lotería y similares  '),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('931050','Servicios de acondicionamiento físico','Servicios de acondicionamiento físico (Incluye gimnasios de musculación, pilates, yoga, personal trainner, etc.)'),
	 ('931090','Servicios para la práctica deportiva n.c.p.','Servicios para la práctica deportiva n.c.p.'),
	 ('939010','Servicios de parques de diversiones y parques temáticos','Servicios de parques de diversiones y parques temáticos'),
	 ('939020','Servicios de salones de juegos','Servicios de salones de juegos (Incluye salones de billar, pool, bowling, juegos electrónicos, etc.) '),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('949200','Servicios de organizaciones políticas','Servicios de organizaciones políticas'),
	 ('949910','Servicios de mutuales, excepto mutuales de salud y financieras','Servicios de mutuales, excepto mutuales de salud y financieras'),
	 ('949920','Servicios de consorcios de edificios','Servicios de consorcios de edificios'),
	 ('949930','Servicios de cooperativas cuando realizan varias actividades','Servicios de cooperativas cuando realizan varias actividades'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('952920','Reparación de relojes y joyas. Relojerías','Reparación de relojes y joyas. Relojerías'),
	 ('952990','Reparación de efectos personales y enseres domésticos n.c.p.','Reparación de efectos personales y enseres domésticos n.c.p. (Incluye la actividad de arreglos de prendas realizadas por modistas), (No incluye la actividad de sastres y modistas que confeccionan prendas: grupo 141)      '),
	 ('960101','Servicios de limpieza de prendas prestado por tintorerías rápidas','Servicios de limpieza de prendas prestado por tintorerías rápidas'),
	 ('960102','Lavado y limpieza de artículos de tela, cuero y/o de piel, incluso la limpieza en seco','Lavado y limpieza de artículos de tela, cuero y/o de piel, incluso la limpieza en seco'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('990000','Servicios de organizaciones y órganos extraterritoriales','Servicios de organizaciones y órganos extraterritoriales'),
	 ('952100','Reparación de artículos eléctricos y electrónicos de uso doméstico','Reparación de artículos eléctricos y electrónicos de uso doméstico (Incluye  TV, radios, reproductores cd''s y dvd''s, cámaras de video de uso familiar, heladeras, lavarropas, secarropas, aire acondicionado de menos de 6000 frigorías)'),
	 ('476200','Venta al por menor de CD''s y DVD''s de audio y video grabados','Venta al por menor de CD''s y DVD''s de audio y video grabados (Incluye CD''s y DVD''s vírgenes)'),
	 ('464910','Venta al por mayor de CD''s y DVD''s de audio y video grabados.','Venta al por mayor de CD''s y DVD''s de audio y video grabados.'),
...
INSERT INTO activities_eco_f833 (code,description,description_large) VALUES
	 ...
	 ('000009','Ama de casa','Ama de casa'),
	 ('000010','Ex - Agente de la Adm. Publica','Ex - Agente de la Adm. Publica'),
	 ('000011','Trabajo Relac. Dependencia','Trabajo Relac. Dependencia'),
	 ('000012','Sin Actividad Economica','Sin Actividad Economica'),
	 ('000013','Agricultura Familiar','Agricultura Familiar');
